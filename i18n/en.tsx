export default {
  ...
  cookie: {
    message:
      'We serve cookies to analyse traffic to this site. Information about your use of this site is shared with we for that purpose.',
  ...
  head: {
    title:
      'COGNANO - Providing Novel Biomarkers for Drug Discovery Decision-Making',
    description:
      'We leverage antibody data and cutting-edge AI technology to develop highly accurate drug discovery seeds and diagnostic tools.',
  },
  datasets: {
    datasets: 'Datasets',
