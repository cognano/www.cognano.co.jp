export default {
  ...
  cookie: {
    message:
      'トラフィックを分析するためにCookieを利用しています。このサイトの使用に関する情報は、その目的のために私たちと共有されます。',
    buttonText: '同意する',
  ...
  index: {
    ...
    kyotogoshaLabAddress:
      '〒602-0841 京都府京都市上京区河原町通今出川下る梶井町448-5',
    kyotogoshaLabName: 'クリエイション・コア京都御車',
    openfold:
      'OpenFoldは、AIを活用した計算構造生物学の研究を推進する非営利コンソーシアムです。無償でオープンソースのソフトウェアを開発することで、タンパク質構造予測の民主化と創薬の加速を目指しています。アカデミアや産業界のリーダーと連携しながら、AIの力で革新的な治療法の発見を可能にする最先端技術を構築しています。',
  },
  about: {
    purpose: 'パーパス',
    story: 'ストーリー',
  ...
  sampleData: {
    ...
    thanks:
      'お申込みありがとうございます！担当者より折り返しご連絡いたします。',
  },
  language: {
    ja: '日本語',
    en: '英語',
  ...
  head: {
    ...
    description:
      '私たちは、抗体データと最先端のAI技術を活用し、精度の高い創薬シーズや検査薬を開発しています。',
  },
  error404: {
    title: '404',
