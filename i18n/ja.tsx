export default {
  ...
  contact: {
    ...
    copy: 'コピー',
    copied: 'コピーしました',
    integrityTitle: '研究不正に関する相談・通報窓口',
    integrityDesc:
      '当社では、文部科学省の「研究活動における不正行為への対応等に関するガイドライン」に基づき、研究不正に関する相談・通報窓口を設けております。 不正行為に関するご指摘やお問い合わせは、下記連絡先までお寄せください。',
  },
  sampleData: {
    affiliation: '所属',
    ...
    namePlaceholder: 'お名前',
    agreementLabel: '上記の合意書に同意します',
    agreementRequired: '* 合意書への同意が必要です。',
    thanks:
