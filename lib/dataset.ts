...
export const GetMomLibs = async (
  name: string,
): Promise<QueryDatabaseResponseEx> => {
  const q = {
...
const GetExternalLinksAndSchemas = async (
  name: string,
): Promise<QueryDatabaseResponseEx> => {
  const q = {
