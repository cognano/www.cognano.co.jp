...
import { GetFAQs, type LocalizedFAQWithBlocks } from '../lib/faq'
import CreateOgImage from '../lib/ogimage'
import { GetProjectsOriginal, projectsQueryLatest } from '../lib/project'
import { GetQEs, type LocalizedQE } from '../lib/qe'
    ...
    <>
      ...
      <main>
            ...
            <div className={styles.hero}>
              <div className={styles.heroText}>
                ...
                <p className={styles.button}>
                  <Link href='/about'>{t('index.aboutUs')}</Link>
                </p>
              </div>
              <div className={styles.heroImage}>
                <div className={styles.ibmet}>
                  <Image
                    src='/static/ibmet-flow.webp'
                    width={625}
                    height={750}
                    alt='IBMET'
                  />
        ...
        <div className={styles.elevatorPitch}>
          ...
          <div className={styles.proof}>
            <div className={styles.halfcontainerC}>
              ...
              <p className={styles.button}>
                <Link href='/datasets'>{t('index.datasets')}</Link>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.qes}>
            {qes.map((v, i) => (
              <div className={styles.qe} key={i}>
                <p className={styles.qeTitle}>{v.title}</p>
                <p className={styles.qeNumber}>
                  {v.number}
                  <span className={styles.qeUnit}>{v.unit}</span>
                </p>
              </div>
            ))}
          </div>
          ...
          <div className={styles.faqs}>
            {faqs.map((v, i) => (
              <div className={styles.faq} key={i}>
                <h3 className={styles.faqQ}>{v.question}</h3>
        ...
        <section className={styles.office}>
          ...
          <div className={styles.officeInner}>
            <div className={styles.kyoto}>
              <div className={styles.officeImage}>
                ...
                <div className={styles.officeImageLicense}>
                  <Unsplash
                    href='https://unsplash.com/@blackodc?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash'
                    name='Su San Lee'
                  />
                </div>
              </div>
              <h3 className={styles.officeName}>{t('index.kyoto')}</h3>
            ...
            <div className={styles.somerville}>
              <div className={styles.officeImage}>
                ...
                <div className={styles.officeImageLicense}>
                  <Unsplash
                    href='https://commons.wikimedia.org/wiki/File:Davis_Square_looking_north_down_Holland_Street_2.jpg'
                    name='4300streetcar'
                    host='wikipedia'
                    hostUrl='https://en.wikipedia.org/wiki/Somerville,_Massachusetts'
                  />
                </div>
              </div>
              <h3 className={styles.officeName}>{t('index.somerville')}</h3>
              <p className={styles.officeAddress}>
          ...
          <h2 className={styles.officeTitle}>{t('index.lab')}</h2>
          <div className={styles.labInner}>
            <div className={styles.kyoto}>
              <div className={styles.officeImage}>
                <Image
                  src='/static/biolab.webp'
                  width={600}
                  height={300}
                  alt='Kyoto Lab'
                />
                <div className={styles.officeImageLicense}>
                  <Unsplash
                    href='https://unsplash.com/photos/black-and-silver-coffee-maker-on-white-wooden-table-_9xRHrMOjeg'
        ...
        <div className={styles.openfold}>
          <div className={styles.openfoldInner}>
            ...
            <div className={styles.openfoldAbout}>
              <a
                href='https://openfold.io/'
                target='_blank'
                rel='noreferrer noopener'
              >
                <Image
                  src='/static/openfold.png'
                  width={455}
                  height={112}
                  alt='OpenFold'
                />
          ...
          <div className={styles.blogWrapper}>
            <header className={styles.blogHeader}>
              ...
              <p className={styles.blogIndexLink}>
                <Link href='/blog'>{t('index.viewAllBlog')} &rarr;</Link>
              </p>
            </header>
            <BlogList blog={blog} />
          </div>
          ...
          <div className={styles.newsWrapper}>
            <header className={styles.newsHeader}>
              ...
              <p className={styles.newsIndexLink}>
                <Link href='/news'>{t('index.viewAllNews')} &rarr;</Link>
              </p>
            </header>
            <NewsList news={news} />
          </div>
