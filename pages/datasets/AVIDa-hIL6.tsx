    ...
    distribution: [
      {
        "@type": "DataDownload",
        encodingFormat: "CSV",
        contentUrl: "https://zenodo.org/record/7935862/download/your-dataset.csv"
      }
    ],
