      ...
      <div className={styles.pageHeader}>
        ...
        <div className={styles.abstract}>
          <p className={styles.categoryLabel}>
            <Link href='/datasets'>{t('datasets.datasets')}</Link>
          </p>
          <h1 className={styles.title}>{abstract.title}</h1>
          <div className={styles.description}>
            <Page blocks={abstract.blocks} />
          </div>
          <div className={styles.download}>
            <div className={`button ${styles.downloadButton}`}>
              <a href={meta.links.dataset.url}>{meta.links.dataset.text}</a>
            </div>
      ...
      {columns && (
        <div className='container'>
          <div className={styles.columns}>
            <h2 className={styles.columnsTitle}>{columns.title}</h2>
      ...
      {pipeline && (
        <div className='container'>
          <div className={styles.pipeline}>
            <h2 className={styles.pipelineTitle}>{pipeline.title}</h2>
            ...
            <div className={styles.externalLinks}>
              {meta.links.fasta && (
                <div className={`button ${styles.externalLink}`}>
                  ...
                  <a href={meta.links.fasta.url}>{meta.links.fasta.text}</a>
                </div>
              )}
              {meta.links.tables && (
                <div className={`button ${styles.externalLink}`}>
                  <p>{meta.links.tables.name}</p>
                  <a href={meta.links.tables.url}>{meta.links.tables.text}</a>
                </div>
              )}
              {meta.links.scripts && (
                <div className={`button ${styles.externalLink}`}>
                  <p>{meta.links.scripts.name}</p>
                  <a href={meta.links.scripts.url}>{meta.links.scripts.text}</a>
                </div>
              )}
            </div>
          </div>
      ...
      {statistics && (
        <div className='container'>
          <div className={styles.statistics}>
            <h2 className={styles.statisticsTitle}>{statistics.title}</h2>
      ...
      {momlibs && (
        <div className='container'>
          <div className={styles.momlibs}>
            <h3 className={styles.momlibsTitle}>{momlibs.title}</h3>
      ...
      {sublibs && (
        <div className='container'>
          <div className={styles.sublibs}>
            <h3 className={styles.sublibsTitle}>{sublibs.title}</h3>
      ...
      {subjects && (
        <div className='container'>
          <div className={styles.subjects}>
            <h3 className={styles.subjectsTitle}>{subjects.title}</h3>
      ...
      {antigens && (
        <div className='container'>
          <div className={styles.antigens}>
            <h3 className={styles.antigensTitle}>{antigens.title}</h3>
