    ...
    <footer className={`${styles.footer} container`}>
      ...
      <div className={styles.siteinfo}>
        <div>
          ...
          <p className={styles.copyright}>&copy; {nowYear} COGNANO, Inc.</p>
        ...
        <p className={styles.snsnav}>
          ...
          <a
            ...
            href='https://www.facebook.com/profile.php?id=100057515646298'
            target='_blank'
            rel='noopener noreferrer'
          >
            {facebookIcon()}
          ...
          <a
            ...
            href='https://jp.linkedin.com/company/cognano'
            target='_blank'
            rel='noopener noreferrer'
          >
            {linkedinIcon()}
